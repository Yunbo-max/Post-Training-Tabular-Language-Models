...
from baselines.great_gemma.main import main as train_great_gemma
from baselines.great_gemma.sample import main as sample_great_gemma




from baselines.qwen.main import main as train_qwen
from baselines.qwen.sample import main as sample_qwen
...
def get_args():
    ...
    parser.add_argument('--bs', type=int, default=4, help='(Maximum) batch size')
