...
def main():
    ...
    # ABLATION: Random scoring - assign random rewards instead of MIA-based rewards
    print("ABLATION: Using RANDOM scores instead of MIA classifier scores")
    rewards = np.random.rand(len(new_synthetic_data))
    ...
    mia_data = pd.DataFrame({
        ...
        'mia_reward': rewards,
        'distance_from_0.5': np.abs(rewards - 0.5),
